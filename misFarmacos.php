...
<head>
    ...
    <meta name="title" content="La pagina para ver tus propios farmacos">
    <meta name="keywords" content="farmaco, propio, imagen, farmacos">
    <meta name="description" content="esta pagina muestra los farmacos que estan bajo tu nombre, tus propios farmacos">
    <link rel="stylesheet" href="css/farmacos.css">
    <link rel="stylesheet" href="css/general.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <title>La pagina para ver tus propios farmacos</title>
</head>
<body>
    ...
    <div id="body">
        ...
        <div class="first-body">
            <img class="body-images" src="img/farmaco.jpg" alt="imagen farmaco convoi"/>
            <div>
        ...
        <div class="first-body">
            <img class="body-images" src="img/farmaco.jpg" alt="imagen farmaco 2"/>
            <div>
                <h1><a href="farmac.php">NOM FÁRMACO</a></h1>
                <p>
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit.</br> Eligendi rerum repellat magnam similique praesentium
        ...
        <div class="first-body">
            <img class="body-images" src="img/farmaco.jpg" alt="imagen farmaco 3"/>
            <div>
                <h1><a href="farmac.php">NOM FÁRMACO</a></h1>
                <p>
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit.</br> Eligendi rerum repellat magnam similique praesentium
        ...
        <div class="first-body">
            <img class="body-images" src="img/farmaco.jpg" alt="imagen farmaco 4"/>
            <div>
                <h1><a href="farmac.php">NOM FÁRMACO</a></h1>
                <p>
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit.</br> Eligendi rerum repellat magnam similique praesentium
